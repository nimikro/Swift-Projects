...
// Added a nagivation controller to the main storyboard and set preferred title to Large
...
class ViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UISearchBarDelegate {
    ...
    // create the search bar as a navigation item
